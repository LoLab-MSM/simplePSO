...
def display(position):
    ...
    plt.semilogx(exp_data['Time (secs)'].values, sim2['pTyr_jnk3'], color='black', label='pJNK3 by MKK4 sim')
    ...
    plt.semilogx(exp_data['Time (secs)'].values, sim2['pThr_jnk3'], color='green', label='pJNK3 by MKK7 sim')
    ...
    plt.legend()
    plt.savefig('jnk3_noASK1_trained.png')
    plt.show()
...
def run_example():
    ...
    pso.run(50, 300)
    display(pso.best)
    np.save('jnk3_noASK1_calibrated_pars', pso.best)
