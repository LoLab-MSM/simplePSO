...
Rule('bind_RIP1po4_MLKLum_to_RIP1po4MLKLum', RIP1(bscf = None, bub1 = None, bub2 = None, bub3 = None, bDD=None, btraf=None, bMLKL = ANY, bRHIM = 5, state = 'po4')% RIP3(bRHIM=5, bDD = ANY, state='po4') + MLKL(bRHIM=ANY, state='um')
     | RIP1(bscf = None, bub1 = None, bub2 = None, bub3 = None, bDD=None, btraf=None, bMLKL = ANY, bRHIM = 5, state = 'po4')% RIP3(bRHIM=5, bDD = ANY, state='po4') % MLKL(bRHIM=ANY, state='um'), bind_RIP1po4_MLKLum_to_RIP1po4MLKLum_kf,bind_RIP1po4_MLKLum_to_RIP1po4MLKLum_kr)

Rule('catalyze_RIP1po4MLKLum_to_RIP1po4_MLKLactive', RIP1(bscf = None, bub1 = None, bub2 = None, bub3 = None, bDD=None, btraf=None, bMLKL = ANY, bRHIM = 5, state = 'po4')% RIP3(bRHIM=5, bDD = ANY, state='po4') % MLKL(bRHIM=ANY, state='um')
