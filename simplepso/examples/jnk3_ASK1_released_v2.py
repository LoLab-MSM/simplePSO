...
# MKK4 ASK1 release
Parameter('kf_MKK4_Ask1_release', 5)

# MKK7 ASK1 release
Parameter('kf_MKK7_Ask1_release', 7)
...
Rule('MKK4Ask1Release', ASK1(b=1, state='P') % Arrestin(b1=1, b2=2, b3=None) % MKK4(b=2, state='P') >>
      Arrestin(b1=None, b2=2, b3=None) % MKK4(b=2, state='P') + ASK1(b=None, state='P'), kf_MKK4_Ask1_release)

Rule('MKK7Ask1Release', ASK1(b=1, state='P') % Arrestin(b1=1, b2=2, b3=None) % MKK7(b=2, state='P') >>
      Arrestin(b1=None, b2=2, b3=None) % MKK7(b=2, state='P') + ASK1(b=None, state='P'), kf_MKK7_Ask1_release)

Rule('MKK4BindJNK3', Arrestin(b1=None, b2=2, b3=None) % MKK4(b=2, state='P') + JNK3(b=None, tyro='U') |
     Arrestin(b1=None, b2=2, b3=3) % MKK4(b=2, state='P') % JNK3(b=3, tyro='U'), kf_MKK4_uJNK3_Arr, kr_MKK4_uJNK3_Arr)

Rule('MKK4catJNK3', Arrestin(b1=None, b2=2, b3=3) % MKK4(b=2, state='P') % JNK3(b=3, tyro='U') >>
     Arrestin(b1=None, b2=2, b3=None) % MKK4(b=2, state='P') + JNK3(b=None, tyro='P'),kcat_pMKK4_JNK3)
...
Rule('MKK7catJNK3', Arrestin(b1=None, b2=2, b3=3) % MKK7(b=2, state='P') % JNK3(b=3, threo='U') >>
     Arrestin(b1=None, b2=2, b3=None) % MKK7(b=2, state='P') + JNK3(b=None, threo='P'), kcat_pMKK7_JNK3)
